...
export const categoryToSmallImageMap: Record<string, string> = {
  '주거/공간': IdeaHousing,
  '교육/학습': IdeaEducation,
  '환경/지속가능성': IdeaEnvironment,
  '기타': IdeaEtc,
  '경제/금융': IdeaFinance,
  '의료/건강': IdeaHealth,
  '육아/살림': IdeaParenting,
  '관계/심리': IdeaRelationships,
  '사회/커뮤니티': IdeaSocialCommunity,
  '문화/생활': IdeaCulture,
  '기술/AI': IdeaTechnologyAI,
  '브랜드 디자인': DesignBrand,
  '아이콘 디자인': DesignIcon,
  '인터렉션 및 모션 디자인': DesignMotionInteraction,
  'UI/UX디자인': DesignUIUX,
  '비주얼 그래픽 디자인': DesignVisualGraphic,
  'AI 기능 활용': BackAi,
  '백엔드': BackBack,
  'API 연동': FrontAPIIntegration,
  '데이터 시각화': FrontDataVisualization,
  '인터렉션/애니메이션': FrontInteractionAnimation,
  '레이아웃/그리드': FrontLayoutGrid,
  '성능 최적화': FrontPerformance,
  '상태 관리': FrontStateManagement,
};