export const cardBackgrounds: Record<string, string> = {
  ...
  '교육/학습': '/assets/card/ideaEducation.svg',
  '환경/지속가능성': '/assets/card/ideaEnvironment.svg',
  '기타': '/assets/card/ideaEtc.svg',
  '경제/금융': '/assets/card/ideaFinance.svg',
  '의료/건강': '/assets/card/ideaHealth.svg',
  '육아/살림': '/assets/card/ideaParenting.svg',
  '관계/심리': '/assets/card/ideaRelationships.svg',
  '사회/커뮤니티': '/assets/card/ideaSocialCommunity.svg',
  '문화/생활': '/assets/card/ideaCulture.svg',
